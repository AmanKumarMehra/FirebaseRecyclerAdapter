...
public class myadapter extends FirebaseRecyclerAdapter<model,myadapter.myviewholder>
{
    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull final model model) {
        holder.nametext.setText(model.getAadharNumData());
        holder.coursetext.setText(model.getAgeData());
        holder.emailtext.setText(model.getPhoneNumData());
        ...
        holder.img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapper,new descfragment(model.getAadharNumData(),model.getAgeData(),model.getPhoneNumData(),model.getImageURL2(), model.getVerified())).addToBackStack(null).commit();
            }
        });
